...
class DashboardPanel {
    ...
    async explainFile(relPath) {
        ...
        const content = (0, contextBuilder_1.readFileSafe)(fullPath, 30000);
        ...
        try {
            const explanation = await this._ai.ask(`Explain this file in plain English:\n\nFile: ${relPath}\n\nImports:\n${imports}\n\nContents:\n${content}`, 'You are CodeLens AI. Explain code files in plain, friendly English. Use bullet points. Be concise but complete. Start with a one-line summary, then list what it does, what it depends on, and anything important.');
